...
class RFC6979_P_256(unittest.TestCase):
    ...
    def test_sha1signature(self):
        ...
        self.assertEqual(sign(private_key,P_256(),message,sha1(),RFC6979_k),(RFC6979_r,RFC6979_s))
    ...
    def test_sha224signature(self):
        ...
        self.assertEqual(sign(private_key,P_256(),message,sha224(),RFC6979_k),(RFC6979_r,RFC6979_s))
    ...
    def test_sha256signature(self):
        ...
        self.assertEqual(sign(private_key,P_256(),message,sha256(),RFC6979_k),(RFC6979_r,RFC6979_s))
    ...
    def test_sha384signature(self):
        ...
        self.assertEqual(sign(private_key,P_256(),message,sha384(),RFC6979_k),(RFC6979_r,RFC6979_s))
    ...
    def test_sha512signature(self):
        ...
        self.assertEqual(sign(private_key,P_256(),message,sha512(),RFC6979_k),(RFC6979_r,RFC6979_s))
    ...
    def test_sha1_verification(self):
        ...
        signature=sign(private_key,P_256(),message,sha1(),RFC6979_k)
    ...
    def test_sha224_verification(self):
        ...
        RFC6979_k=0x103F90EE9DC52E5E7FB5132B7033C63066D194321491862059967C715985D473
        publickey=public_key(P_256(),private_key)
        signature=sign(private_key,P_256(),message,sha224(),RFC6979_k)
    ...
    def test_sha256_verification(self):
        ...
        RFC6979_k=0xA6E3C57DD01ABE90086538398355DD4C3B17AA873382B0F24D6129493D8AAD60
        publickey=public_key(P_256(),private_key)
        signature=sign(private_key,P_256(),message,sha256(),RFC6979_k)
    ...
    def test_sha384_verification(self):
        ...
        RFC6979_k = 0x09F634B188CEFD98E7EC88B1AA9852D734D0BC272F7D2A47DECC6EBEB375AAD4
        publickey=public_key(P_256(),private_key)
        signature=sign(private_key,P_256(),message,sha384(),RFC6979_k)
    ...
    def test_sha512_verification(self):
        ...
        RFC6979_k = 0x5FA81C63109BADB88C1F367B47DA606DA28CAD69AA22C4FE6AD7DF73A7173AA5
        publickey=public_key(P_256(),private_key)
        signature=sign(private_key,P_256(),message,sha512(),RFC6979_k)
